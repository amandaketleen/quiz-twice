...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (pontuacao !== null) {
        ...
        if (pontuacao <= 6) {
            ...
            imagemResultado.src = "/img/jihyo-gif1.gif";  // Caminho correto
            ...
            imagemResultado.src = "/img/jihyo-gif2.gif";  // Substitua pelo caminho da imagem feliz
            imagemResultado.style.display = "block";
        } else if (pontuacao == 10) {
            document.getElementById('pontuacao').innerHTML = `Você acertou ${pontuacao}/10! </br> UAU, você é um ótimo fã da Hyo!`;
            imagemResultado.src = "/img/jihyo-gif3.gif";  // Caminho para imagem especial
            imagemResultado.style.display = "block";
        }
